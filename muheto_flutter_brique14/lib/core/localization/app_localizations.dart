...
class AppLocalizations {
  ...
  ///
  /// [params] permet l'interpolation simple de valeurs dynamiques dans une
  /// chaîne traduite, au format `{nomDuParam}` :
  /// ```dart
  /// // fr.json : "feed.commentsCount": "{count} commentaires"
  /// loc.t('feed.commentsCount', {'count': '12'}); // → "12 commentaires"
  /// ```
