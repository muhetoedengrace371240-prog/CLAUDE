  ...
  Future<void> _publish() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context).t('create.publishSuccess')),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).t('create.publishTitle')),
      ),
      body: AbsorbPointer(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: _isPublishing
                  ...
                  : Text(AppLocalizations.of(context).t('common.publish')),
            ),
          ],
        ),
      ),
