    ...
    return Scaffold(
      ...
      body: StreamBuilder<UserModel?>(
        ...
        builder: (context, userSnap) {
          ...
          if (user == null) {
            return const Center(
              child: Text(AppLocalizations.of(context).t('common.userNotFound'), style: const TextStyle(color: Colors.white70)),
            );
          }
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text(AppLocalizations.of(context).t('profile.editProfile')),
                    ),
                  ),
                      ...
                      builder: (context, followSnap) {
                        ...
                        return isFollowing
                            ? OutlinedButton(
                                ...
                                child: Text(AppLocalizations.of(context).t('profile.followingAction')),
                              )
                            : ElevatedButton(
                                onPressed: onFollowTap,
                                child: Text(AppLocalizations.of(context).t('profile.follow')),
                              );
                      },
                    ),
                  ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isGoldActive ? null : Border.all(color: AppColors.gold.withValues(alpha: 0.4)),
        ),
        child: Row(
          children: [
            Icon(
