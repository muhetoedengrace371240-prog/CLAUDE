...
Future<void> main() async {
  ...
  // d'expiration avec DateFormat(..., dateLocale) où dateLocale dépend de la
  // langue active de l'app (fr_FR / en_US / sw_TZ — le Kirundi n'existe pas
  // dans les données CLDR d'intl et se replie sur fr_FR, voir gold_screen.dart).
  // Sans cette initialisation, l'app plante (LocaleDataException) au premier
  // affichage d'un statut Gold actif dans une langue non initialisée.
