...
/// Durée maximale d'enregistrement en V1 (les membres MUHETO Gold auront
/// droit à 10 minutes — voir la maquette "Vidéos plus longues (10 min)").
...
class _CameraCaptureScreenState extends State<CameraCaptureScreen> {
  ...
  Future<void> _startRecording() async {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      ...
      if (_recordedSeconds >= _kMaxRecordingSeconds) {
        _stopRecording();
      }
    });
  }
              ...
              child: Padding(
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    value: _recordedSeconds / _kMaxRecordingSeconds,
                    minHeight: 4,
              ...
              children: [
                ...
                if (_isRecording)
                  Container(
                    ...
                    child: Text(
                      '${_recordedSeconds}s / ${_kMaxRecordingSeconds}s',
