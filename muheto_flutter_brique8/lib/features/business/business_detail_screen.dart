        ...
        builder: (context, snapshot) {
          ...
          if (business == null) {
            return Scaffold(
              ...
              body: const Center(
                child: Text('Ce commerce est introuvable.', style: TextStyle(color: Colors.white70)),
              ),
            );
          }
          ...
          return CustomScrollView(
            slivers: [
              SliverAppBar(
                ...
                actions: [
                  if (business.ownerId == FirebaseAuth.instance.currentUser?.uid)
                    Padding(
                      padding: const EdgeInsets.all(8),
                      child: _RoundIconButton(
                          ...
                          if (business.phoneNumber.isNotEmpty)
                            Expanded(
                              child: _ActionButton(
                                ...
                                label: 'Appeler',
                                onTap: () => _launch(context, Uri(scheme: 'tel', path: business.phoneNumber)),
                              ),
                            ),
                          ...
                          if (business.websiteUrl.isNotEmpty) ...[
                            ...
                            Expanded(
                              child: _ActionButton(
                                ...
                                label: 'Site web',
                                onTap: () => _launch(context, Uri.parse(business.websiteUrl)),
                              ),
                            ),
                          ],
                        ],
