...
///   - participantsInfo: map<uid, {username, avatarUrl, isGoldMember}>  (dénormalisé)
///   - lastMessage: string
...
class ChatModel {
  ...
  const ChatModel({
    ...
    required this.otherIsGoldMember,
  ...
  factory ChatModel.fromFirestore(
    ...
    return ChatModel(
      ...
      otherIsGoldMember: otherInfo['isGoldMember'] as bool? ?? false,
